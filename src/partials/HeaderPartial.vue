        ...
        <div class="flex items-center w-auto">
          <div class="items__controls">
            <div class="flex" v-if="user">
              <router-link :to="{ name: 'CreateHousePage' }" class="no-underline mr-2 flex items-center text-grey-darkest">
              ...
              <div class="flex items-center">
                <img class="w-8 h-8 rounded-full mr-2" :src="user.avatar" :alt="user.name">
                <div class="text-sm">
            ...
            <div v-else>
              ...
              <button
                class="bg-yellow-dark text-yellow-darker font-semibold py-2 px-4 rounded" @click.prevent="getRegister">
                Register</button>
            </div>
          </div>
        </div>
